# Event Subscription submodule for Event Grid System Topics
# This submodule can be used to create event subscriptions on existing Event Grid System Topics
...
resource "azapi_resource" "this" {
  name      = var.name
  parent_id = var.system_topic_resource_id
